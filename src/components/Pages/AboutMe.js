    ...
    return (
        <section className = "place-content-center pt-40 pb-40">
            <h1>About Page</h1>
                ...
                <p>After graduating high school, I moved to Dallas, TX to pursue my career in the medical plasma field. While in Dallas, I studied Information Technology at Phoenix University to further progress in my field and to develop my professional knowledge.</p>
            
            
                <p>In 2020, just as Covid19 was ramping up, my current employer brought me to Seattle where I now reside and work. </p>
            

            
                <p>When time allows, I am a very passionate world traveler, an avid snowboarder, and occasionally a timid skydiver.</p>
